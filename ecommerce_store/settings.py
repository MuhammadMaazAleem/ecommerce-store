...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-9c9-)d64gt5^%_%#d*l)32)eq1-tdf(5wtw$*(^34h)i-&q+2m')
...
# Email settings (for password reset and order confirmation)
...
# Stripe settings (add your keys later)
